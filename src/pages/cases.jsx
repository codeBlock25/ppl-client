      ...
      <section className="Cases">
        ...
        <div className="container">
          {this.state.loading ? (
                  ...
                  return (
                    <div className="case" key={caser.id}>
                      ...
                      <div className="by">
                        <span className="re">
                          <span>record by:</span>
                          {caser.pertitioner_name}
                        </span>
                        <span className="re">
                          <span>assigned to:</span> {caser.assigned_officer}{" "}
                        </span>
                        <span className="re">
                          <span>record date:</span> {caser.date}{" "}
                        </span>
                        <Button
                          className="viewBtn"
                          onClick={() =>
                            this.props.details.level === 3
                              ? this.props.history.push(`/cases/${caser._id}`)
            ...
            <span className="errCase">no cases</span>
          )}
        </div>
      </section>
    );
