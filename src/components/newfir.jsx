        ...
        <div className={newfir ? "Newstaff open": "Newstaff"}>
            <form onSubmit={(e)=>handleSubmit(e)}>
                ...
                <TextField
                    ...
                    onChange={(e)=>{setvictim_contact(e.target.value)}}
                />
                <TextField
                    className="inputBox"
                    variant="outlined"
                    ...
                    onChange={(e)=>{setvictim_address(e.target.value)}}
                />
                <TextField
                    className="inputBox"
                    variant="outlined"
                    ...
                    required
                    value={accused_name}
                    onChange={(e)=>{setaccused_name(e.target.value)}}
                />
                <TextField
                    className="inputBox"
                    variant="outlined"
                    ...
                    onChange={(e)=>{setaccused_contact(e.target.value)}}
                />
                <TextField
                    className="inputBox"
                    variant="outlined"
                    ...
                    onChange={(e)=>{setaccused_address(e.target.value)}}
                />
                <TextField
                    variant="outlined"
                    id="date"
                    ...
                    value={incident_date}
                    onChange={(e)=>{setincident_date(e.target.value)}}
                />
                <TextField
                    className="inputBox"
                    variant="outlined"
                    ...
                    onChange={(e)=>{setincident_place(e.target.value)}}
                />
                <TextField
                    multiline
                    className="inputBox"
                ...
                />
                <Button type="button" className="submitBtn" onClick={()=>firopen()}>cancel</Button>
